...
class startscreen8(Screen, InfoBarNotifications):
	...
	tmpskin.close()
        ...
        def __init__(self, session, terminliste,version,DPKG=None):
	        ...
	        ue_text = _("Next events:")
                ...
                for x in ges_list:
                    ...
                    if x[3]==4:
                       ...
                       # else:
                        #    res=(vor+x[4]+" "+x[5],x[1], color,cal_bg)
                    elif x[3]==0:
                        vor=" "*5
                        res=(vor+x[1]," ",vor+x[1],x[2],cal_bg)
                    alist.append(res)
                ...
                #self["listlabel"].instance.setBackgroundColor("0xffffff")
        def kalender(self):
